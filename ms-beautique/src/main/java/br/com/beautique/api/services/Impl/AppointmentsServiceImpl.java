...
public class AppointmentsServiceImpl implements AppointmentsService {
    ...
    public AppointmentDTO update(AppointmentDTO appointmentDTO) {
        Optional<AppointmentsEntity> currentAppointmentsEntity = appointmentRepository.findById(appointmentDTO.getId());
        if(currentAppointmentsEntity.isEmpty()){
            throw new RuntimeException("Appointment not found");
        }
        AppointmentsEntity appointmentsEntity = converterUtil.convertToSource(appointmentDTO);
        appointmentsEntity.setCreatedAt(currentAppointmentsEntity.get().getCreatedAt());
        AppointmentsEntity updateAppointmentsEntity = appointmentRepository.save(appointmentsEntity);
        sendAppointmentToQueue(updateAppointmentsEntity);
    ...
    public AppointmentDTO setCustomerToAppointment(AppointmentDTO appointmentDTO) {
        ...
        BeautyProceduresEntity beautyProceduresEntity = findBeautyById(appointmentDTO.getBeautyProcedure());
        ...
        AppointmentsEntity updateAppointments = appointmentRepository.save(appointmentsEntity);
        sendAppointmentToQueue(updateAppointments);
        return buildAppointmentsDTO(updateAppointments);
    }
    ...
    private BeautyProceduresEntity findBeautyById(Long id){
